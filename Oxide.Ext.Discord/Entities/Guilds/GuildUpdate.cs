...
namespace Oxide.Ext.Discord.Entities.Guilds
{
    ...
    public class GuildUpdate : IDiscordValidation
    {
        ...
        public void Validate()
        {
            ...
            InvalidSnowflakeException.ThrowIfInvalid(AfkChannelId, false, nameof(AfkChannelId));
            InvalidSnowflakeException.ThrowIfInvalid(SystemChannelId, false, nameof(SystemChannelId));
        }
    }
}