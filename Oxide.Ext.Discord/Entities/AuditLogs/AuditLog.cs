...
namespace Oxide.Ext.Discord.Entities.AuditLogs
{
    ...
    public class AuditLog
    {
        ...
        /// 
        /// </summary>
        public static void GetGuildAuditLog(DiscordClient client, Snowflake guildId, Action<AuditLog> callback = null, Action<RequestError> error = null)
        {
            client.Bot.Rest.CreateRequest(client,$"guilds/{guildId}/audit-logs", RequestMethod.GET, null, callback, error);
        }
    }
}
