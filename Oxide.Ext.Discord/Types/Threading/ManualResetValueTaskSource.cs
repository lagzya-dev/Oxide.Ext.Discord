...
namespace Oxide.Ext.Discord.Types
{
    ...
    {
        private ManualResetValueTaskSourceCore<object> _taskSource = new ManualResetValueTaskSourceCore<object>();

        public short Version => _taskSource.Version;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal ValueTask GetTask() => new ValueTask(this, _taskSource.Version);
