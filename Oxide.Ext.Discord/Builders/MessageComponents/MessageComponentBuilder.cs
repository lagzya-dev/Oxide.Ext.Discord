...
{
    private readonly List<ActionRowComponent> _components = new();
    ...
    ///     Throw if the button style is a link or if the button goes outside the max number of action rows
    /// </exception>
