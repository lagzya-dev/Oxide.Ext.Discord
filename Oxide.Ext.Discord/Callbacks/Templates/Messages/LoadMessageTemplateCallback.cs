...
namespace Oxide.Ext.Discord.Callbacks.Templates.Messages
{
        ...
        where TEntity : class
    {
        ...
        public static void Start(BaseMessageTemplateLibrary<TTemplate, TEntity> templates, TemplateId id, IDiscordPromise<TTemplate> promise)
        {
        ...
        public static void Start(BaseMessageTemplateLibrary<TTemplate, TEntity> templates, TemplateId id,  DiscordInteraction interaction, IDiscordPromise<TTemplate> promise)
        {
            LoadMessageTemplateCallback<TTemplate, TEntity> load = DiscordPool.Get<LoadMessageTemplateCallback<TTemplate, TEntity>>();
        ...
        private void Init(BaseMessageTemplateLibrary<TTemplate, TEntity> templates, TemplateId id, DiscordInteraction interaction, IDiscordPromise<TTemplate> promise)
        {
