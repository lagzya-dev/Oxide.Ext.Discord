...
internal partial class DiscordExtensionCore : BaseDiscordPlugin
{
    ...
    private void Init()
    {
        ...
        AddCovalenceCommand(["de.version"], nameof(VersionCommand), "de.version");
        AddCovalenceCommand(["de.websocket.reset"], nameof(ResetWebSocketCommand), "de.websocket.reset");
        AddCovalenceCommand(["de.websocket.reconnect"], nameof(ReconnectWebSocketCommand), "de.websocket.reconnect");
        AddCovalenceCommand(["de.rest.reset"], nameof(ResetRestApiCommand), "de.rest.reset");
        AddCovalenceCommand(["de.search.highperformance.enable"], nameof(SearchHighPerformanceEnabled), "de.search.highperformance.enable");
        AddCovalenceCommand(["de.placeholders.list"], nameof(PlaceholdersList), "de.placeholders.list");
        AddCovalenceCommand(["de.pool.clearentities"], nameof(ClearEntitiesDiscordPool), "de.pool.clearentities");
        AddCovalenceCommand(["de.pool.remove"], nameof(RemoveDiscordPool), "de.pool.remove");
        AddCovalenceCommand(["de.log.console"], nameof(ConsoleLogCommand), "de.log.console");
        AddCovalenceCommand(["de.log.file"], nameof(FileLogCommand), "de.log.file");
        AddCovalenceCommand(["de.validation.enable"], nameof(ValidationEnableCommand), "de.validation.enable");
        AddCovalenceCommand(["de.debug"], nameof(DiscordDebugCommand), "de.debug");
        AddCovalenceCommand(["de.help"], nameof(DiscordHelpCommand), "de.help");
