...
namespace Oxide.Ext.Discord.Plugins.Core
{
    internal partial class DiscordExtensionCore
    {
        ...
        public void CreateTemplates()
        {
            ...
            DiscordExtension.DiscordTemplates.RegisterLocalizedMessageTemplate(this, TemplateKeys.Commands.Delete.Success, success, new TemplateVersion(1, 0, 0));
            ...
            DiscordExtension.DiscordTemplates.RegisterLocalizedMessageTemplate(this, TemplateKeys.Commands.Delete.Errors.DeleteCommandError, deleteError, new TemplateVersion(1, 0, 0));
            ...
            DiscordExtension.DiscordTemplates.RegisterLocalizedMessageTemplate(this, TemplateKeys.Commands.Delete.Errors.CommandIdNotFound, commandNotFound, new TemplateVersion(1, 0, 0));
            ...
            DiscordExtension.DiscordTemplates.RegisterLocalizedMessageTemplate(this, TemplateKeys.Commands.Delete.Errors.InvalidSelection, invalidSelection, new TemplateVersion(1, 0, 0));
        }
        ...
        {
            DiscordMessageTemplate message = GetMessageTemplate(key, interaction);
            InteractionCallbackData response = placeholders != null ? message.ToPlaceholderMessage<InteractionCallbackData>(placeholders) : message.ToMessage<InteractionCallbackData>();
            if (interaction.GuildId.HasValue)
            {
                response.Flags = MessageFlags.Ephemeral;
            }
            interaction.CreateInteractionResponse(client, InteractionResponseType.ChannelMessageWithSource, response);
        }
        
        public DiscordMessageTemplate GetMessageTemplate(string key, DiscordInteraction interaction)
        {
            DiscordMessageTemplate message = DiscordExtension.DiscordTemplates.GetMessageTemplate(this, key, interaction);
            return message;
        }
    }
}