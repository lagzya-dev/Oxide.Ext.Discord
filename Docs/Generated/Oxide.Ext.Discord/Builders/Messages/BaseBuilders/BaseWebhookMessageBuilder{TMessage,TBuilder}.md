...
| name | description |
| --- | --- |
| [AddAvatarUrl](#AddAvatarUrl)(…) | Adds a custom avatar url for the sender |
| [AddUserName](#AddUserName)(…) | Adds a custom username for the sender |

## Protected Members

| name | description |
| --- | --- |
| [BaseWebhookMessageBuilder](#BaseWebhookMessageBuilder)(…) | Constructor |
