...
| [Then](#Then-method)(…) | Add a resolved callback that chains a non-value promise. (5 methods) |
| [Then&lt;TConvert&gt;](#Then-method)(…) | Add a resolved callback that chains a value promise (optionally converting to a different value type). (2 methods) |
...
| [ThenAll&lt;TConvert&gt;](#ThenAll-method)(…) | Chain an enumerable of promises, all of which must resolve. Converts to a non-value promise. The resulting promise is resolved when all of the promises have resolved. It is rejected as soon as any of the promises have been rejected. |
