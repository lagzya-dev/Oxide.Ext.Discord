...
| [Then](#then-method-1-of-5)(…) | Add a resolved callback that chains a non-value promise. (5 methods) |
| [Then&lt;TConvert&gt;](#then&amp;lt;tconvert&amp;gt;-method-1-of-2)(…) | Add a resolved callback that chains a value promise (optionally converting to a different value type). (2 methods) |
| [ThenAll](#thenall-method)(…) | Chain an enumerable of promises, all of which must resolve. The resulting promise is resolved when all of the promises have resolved. It is rejected as soon as any of the promises have been rejected. |
| [ThenAll&lt;TConvert&gt;](#thenall&amp;lt;tconvert&amp;gt;-method)(…) | Chain an enumerable of promises, all of which must resolve. Converts to a non-value promise. The resulting promise is resolved when all of the promises have resolved. It is rejected as soon as any of the promises have been rejected. |
| [ThenSequence](#thensequence-method)(…) | Chain a sequence of operations using promises. Return a collection of functions each of which starts an async operation and yields a promise. Each function will be called and each promise resolved in turn. The resulting promise is resolved after each promise is resolved in sequence. |
