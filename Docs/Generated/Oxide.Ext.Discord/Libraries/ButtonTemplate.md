...
| [Style](#style-property) { get; set; } | [`ButtonStyle`](../Entities/ButtonStyle.md) for the button |
| override [ToComponent](#tocomponent-method)(…) | Converts the template to a [`ButtonComponent`](../Entities/ButtonComponent.md) |
...
* [ButtonTemplate.cs](../../../../Oxide.Ext.Discord/Libraries/ButtonTemplate.cs)
   
   
# ToComponent method

Converts the template to a [`ButtonComponent`](../Entities/ButtonComponent.md)
...
| --- | --- |
| label | Button Label |
| style | [`ButtonStyle`](../Entities/ButtonStyle.md) |
...
[`ButtonStyle`](../Entities/ButtonStyle.md) for the button
