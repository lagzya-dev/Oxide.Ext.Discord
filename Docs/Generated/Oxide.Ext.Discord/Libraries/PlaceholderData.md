...
| [AddChannel](#addchannel-method-1-of-2)(…) | Adds a [`DiscordChannel`](../Entities/DiscordChannel.md) by [`DiscordClient`](../Clients/DiscordClient.md), ChannelId, and Optional GuildId (2 methods) |
| [AddCommand](#addcommand-method)(…) | Add a [`DiscordApplicationCommand`](../Entities/DiscordApplicationCommand.md) |
...
| [AddUser](#adduser-method)(…) | Adds a [`DiscordUser`](../Entities/DiscordUser.md) |
| [AddUserTarget](#addusertarget-method)(…) | Adds a [`DiscordUser`](../Entities/DiscordUser.md) |
...
* [PlaceholderData.cs](../../../../Oxide.Ext.Discord/Libraries/PlaceholderData.cs)
   
   
# AddCommand method

Add a [`DiscordApplicationCommand`](../Entities/DiscordApplicationCommand.md)
...
* class [DiscordApplicationCommand](../Entities/DiscordApplicationCommand.md)
...
Add a [`DiscordGuild`](../Entities/DiscordGuild.md)
...
Add a [`DiscordGuild`](../Entities/DiscordGuild.md) by [`DiscordClient`](../Clients/DiscordClient.md) and GuildId
...
Add a [`DiscordMessage`](../Entities/DiscordMessage.md)
...
Add a [`GuildMember`](../Entities/GuildMember.md)
...
Add a [`GuildMember`](../Entities/GuildMember.md) by [`DiscordClient`](../Clients/DiscordClient.md), GuildId, and UserId
...
Adds a [`DiscordUser`](../Entities/DiscordUser.md)
...
Adds a [`DiscordRole`](../Entities/DiscordRole.md)
...
Adds a [`DiscordRole`](../Entities/DiscordRole.md) by [`DiscordClient`](../Clients/DiscordClient.md), GuildId, and RoleId
...
Adds a [`DiscordChannel`](../Entities/DiscordChannel.md)
...
Adds a [`DiscordChannel`](../Entities/DiscordChannel.md) by [`DiscordClient`](../Clients/DiscordClient.md), ChannelId, and Optional GuildId
...
Adds a [`DiscordInteraction`](../Entities/DiscordInteraction.md)
