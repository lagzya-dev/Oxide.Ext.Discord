...
| [Emoji](#emoji-property) { get; set; } | The emoji used for a custom status See [`DiscordEmoji`](../Emojis/DiscordEmoji.md) |
...
* [DiscordActivity.cs](../../../../Oxide.Ext.Discord/Entities/Activities/DiscordActivity.cs)
   
   
...
The emoji used for a custom status See [`DiscordEmoji`](../Emojis/DiscordEmoji.md)
