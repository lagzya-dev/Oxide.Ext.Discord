...
| name | description |
| --- | --- |
| [SelectMenuOption](#SelectMenuOption)() | The default constructor. |
| [Default](#Default) { get; set; } | Will show this option as selected by default |
| [Description](#Description) { get; set; } | Additional description of the option, Max 100 characters |
| [Emoji](#Emoji) { get; set; } | Emoji in the option |
| [Label](#Label) { get; set; } | User-facing name of the option, Max 100 characters |
| [Value](#Value) { get; set; } | Dev-define value of the option, Max 100 characters |
| [Validate](#Validate)() |  |
