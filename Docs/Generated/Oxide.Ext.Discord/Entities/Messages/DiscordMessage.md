...
| [Application](#application-property) { get; set; } | Sent with Rich Presence-related chat embeds [`Application`](./#application-property) |
...
| [Embeds](#embeds-property) { get; set; } | Any embedded content [`Embeds`](./#embeds-property) |
...
| [MessageReference](#messagereference-property) { get; set; } | Data showing the source of a crosspost, channel follow add, pin, or reply message [`MessageReference`](./#messagereference-property) |
