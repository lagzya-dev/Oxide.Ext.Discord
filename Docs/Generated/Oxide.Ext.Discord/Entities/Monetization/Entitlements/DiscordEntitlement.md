...
| [CreateTestEntitlement](#createtestentitlement-method)(…) | Creates a test entitlement to a given SKU for a given guild or user. Discord will act as though that user or guild has entitlement to your premium offering. |
| [DeleteTestEntitlement](#deletetestentitlement-method)(…) | Deletes a currently-active test entitlement. Discord will act as though that user or guild no longer has entitlement to your premium offering. |
| static [GetEntitlements](#getentitlements-method)(…) | Returns all entitlements for a given app, active and expired. |

## See Also

* namespace [Oxide.Ext.Discord.Entities.Monetization.Entitlements](./EntitlementsNamespace.md)
* assembly [Oxide.Ext.Discord](../../../../Oxide.Ext.Discord.md)
* [DiscordEntitlement.cs](../../../../Oxide.Ext.Discord/Entities/Monetization/Entitlements/DiscordEntitlement.cs)
   
   
