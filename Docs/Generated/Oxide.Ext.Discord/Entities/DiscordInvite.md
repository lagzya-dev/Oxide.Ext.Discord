...
| [Channel](#channel-property) { get; set; } | The channel this invite is for See [`DiscordChannel`](./DiscordChannel.md) |
| [Code](#code-property) { get; set; } | The invite code (unique ID) |
| [ExpiresAt](#expiresat-property) { get; set; } | When the invite code expires |
| [Guild](#guild-property) { get; set; } | The guild this invite is for See [`DiscordGuild`](./DiscordGuild.md) |
...
* [DiscordInvite.cs](../../../../Oxide.Ext.Discord/Entities/DiscordInvite.cs)
   
   
# Get method
...
The guild this invite is for See [`DiscordGuild`](./DiscordGuild.md)
...
The channel this invite is for See [`DiscordChannel`](./DiscordChannel.md)
...
The user who created the invite See [`DiscordUser`](./DiscordUser.md)
...
The target user for this invite See [`DiscordUser`](./DiscordUser.md)
