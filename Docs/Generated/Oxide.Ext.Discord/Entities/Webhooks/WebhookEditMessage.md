...
| name | description |
| --- | --- |
| [WebhookEditMessage](#WebhookEditMessage)() | The default constructor. |
...
| [Content](#Content) { get; set; } | The message contents (up to 2000 characters) |
| [Embeds](#Embeds) { get; set; } | Embedded rich content (Up to 10 embeds) |
...
| [AddEmbed](#AddEmbed)(…) | Adds a new embed to the list of embed to send |
| [Validate](#Validate)() |  |
