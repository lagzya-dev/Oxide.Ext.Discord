...
| [Application](#application-property) { get; set; } | Contains id and flags See [`DiscordApplication`](./DiscordApplication.md) |
...
| [User](#user-property) { get; set; } | Information about the user including email See [`DiscordUser`](./DiscordUser.md) |
...
* [GatewayReadyEvent.cs](../../../../Oxide.Ext.Discord/Entities/GatewayReadyEvent.cs)
   
   
...
Information about the user including email See [`DiscordUser`](./DiscordUser.md)
...
Contains id and flags See [`DiscordApplication`](./DiscordApplication.md)
