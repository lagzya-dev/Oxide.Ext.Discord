...
| name | description |
| --- | --- |
| [GuildChannelUpdate](#GuildChannelUpdate)() | The default constructor. |
| [AvailableTags](#AvailableTags) { get; set; } | The set of tags that can be used in a GUILD_FORUM channel |
| [Bitrate](#Bitrate) { get; set; } | The bitrate (in bits) of the voice channel 8000 to 96000 (128000 for VIP servers) |
| [DefaultAutoArchiveDuration](#DefaultAutoArchiveDuration) { get; set; } | The default duration for newly created threads in the channel, in minutes, to automatically archive the thread after recent activity |
...
| [Position](#Position) { get; set; } | The position of the channel in the left-hand listing |
...
| [RtcRegion](#RtcRegion) { get; set; } | Channel voice region id, automatic when set to null |
| [Topic](#Topic) { get; set; } | The channel topic (0-1024 characters) |
| [Type](#Type) { get; set; } | the type of channel See [`ChannelType`](./ChannelType.md) |
| [UserLimit](#UserLimit) { get; set; } | The user limit of the voice channel |
| [VideoQualityMode](#VideoQualityMode) { get; set; } | The camera video quality mode of the voice channel |
| [Validate](#Validate)() |  |
